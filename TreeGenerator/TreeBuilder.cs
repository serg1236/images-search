...
namespace TreeGenerator
{
    public class TreeBuilder : IDisposable
    {
        ...
        private int _HorizontalSpace = 60;
        private int _VerticalSpace = 60;
        private int _FontSize = 9;
        private int imgWidth = 0;
        private int imgHeight = 0;
        private Graphics gr;
        private Color[] _groupColors = { Color.Blue, Color.Red, Color.Orange, Color.Green, Color.Pink, Color.Violet, Color.Gray };
        ...
        */
        ...
        /// </summary>
        private void DrawChart(XmlNode oNode, Color lineColor)
        {
            ...
            {
                int colorIndex = int.Parse(groupNumber);
                foreach (XmlNode childNode in oNode.ChildNodes)
                {
                    DrawChart(childNode, _groupColors[colorIndex % _groupColors.Length]);
                }
